...
module.exports =
	all:
		options:
			...
			[FIXME] PhantomJS shows errors for Kristinita’s search page:
			"http://localhost:4147/<%= templates.yamlconfig.OUTPUT_PATH %>/index.html"
			https://app.travis-ci.com/github/Kristinita/KristinitaPelican/jobs/560271333#L2909-L2921
			###
			url: [	"http://localhost:4147/<%= templates.yamlconfig.OUTPUT_PATH %>/404.html"
